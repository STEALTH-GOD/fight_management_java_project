...
/**
 * The AddFlightWindow class provides a GUI for adding a new flight to the Flight Booking System.
 * It allows users to input flight details including flight number, origin, destination, 
...
public class AddFlightWindow extends JFrame implements ActionListener {
    ...
    /**
     * Constructs an AddFlightWindow and initializes the GUI components.
     * 
    ...
    /**
     * Initializes the GUI components and layout of the AddFlightWindow.
     * Sets up the input fields for flight details and action buttons.
     */
    private void initialize() {
        try {
            UIManager.setLookAndFeel(UIManager.getSystemLookAndFeelClassName());
        } catch (Exception ex) {
            // Ignore if the look and feel setting fails
        }
        ...
        bottomPanel.add(new JLabel("     ")); // Spacer for alignment
    ...
    /**
     * Handles action events triggered by the "Add" and "Cancel" buttons.
     * 
    ...
    /**
     * Collects input data and attempts to add a new flight to the system.
     * It handles exceptions for date format, number format, and system errors.
     */
    private void addFlight() {
        try {
            ...
            // Refresh the flight list and close this window
